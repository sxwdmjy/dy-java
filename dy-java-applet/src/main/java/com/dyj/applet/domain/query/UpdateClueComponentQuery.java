 ...
 **/
public class UpdateClueComponentQuery extends BaseQuery {
    ...
    public static class CreateClueComponentQueryBuilder {
        ...
        public CreateClueComponentQueryBuilder configId(String configId) {
        ...
        public UpdateClueComponentQuery build() {
            UpdateClueComponentQuery createClueComponentQuery = new UpdateClueComponentQuery();
            createClueComponentQuery.setConfig_id(configId);
